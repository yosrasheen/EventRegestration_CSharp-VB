<%@ Page Title="" Language="VB" MasterPageFile="~/Admincp/MasterPage.master" AutoEventWireup="false" CodeFile="Events_workshopsEdit.aspx.vb" Inherits="Admincp_Events_workshops_Events_workshopsEdit" %>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td>
                            ورشة العمل</td>
                        <td>
                            <asp:TextBox ID="txtWorkshop_Name" runat="server" Width="200px"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
